...
class MP
{
    ...
    {
        $this->client_id = config('mercadopago.app_id');
        $this->client_secret = config('mercadopago.app_secret');
    }

    public function sandbox_mode($sandboxMode = null)
    {
...
class MPRestClient
{
    ...
    private static function buildRequest($request)
    {
        ...
        curl_setopt($connect, CURLOPT_CAINFO, $GLOBALS["LIB_LOCATION"] . "/cacert-2019-01-23.pem");
