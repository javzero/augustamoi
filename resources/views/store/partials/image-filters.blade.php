...
<div class="container">
	<div class="row image-filters">
		<a class="col-md-4 image-filters-1" href="{{ route('store', ['filtrar' => 'descuentos']) }}">
		...
		<a class="col-md-4 image-filters-2" href="{{ route('store', ['filtrar' => 'populares']) }}">
		...
		<a class="col-md-4 image-filters-3" href="{{ route('store', ['filtrar' => 'nuevos']) }}">
