...
Route::group(['prefix' => 'vadmin', 'middleware' => 'managers'], function(){
    ...
    Route::get('exportar-mails-de-clientes/{format}', ['as' => 'vadmin.exportCustomerEmails', 'uses' => 'CustomerController@exportCustomerEmails']);
    ...
    Route::get('exportRotuleAndOrder/{id}', ['as' => 'vadmin.exportRotuleAndOrder', 'uses' => 'Store\OrdersController@exportRotuleAndOrder']);
